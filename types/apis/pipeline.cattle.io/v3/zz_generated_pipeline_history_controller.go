...
type PipelineHistoryController interface {
	...
	AddHandler(handler PipelineHistoryHandlerFunc)
...
type PipelineHistoryInterface interface {
	...
	GetNamespace(name, namespace string, opts metav1.GetOptions) (*PipelineHistory, error)
	...
	AddSyncHandler(sync PipelineHistoryHandlerFunc)
...
func (c *pipelineHistoryController) AddHandler(handler PipelineHistoryHandlerFunc) {
...
func (s *pipelineHistoryClient) GetNamespace(name, namespace string, opts metav1.GetOptions) (*PipelineHistory, error) {
...
func (s *pipelineHistoryClient) DeleteNamespace(name, namespace string, options *metav1.DeleteOptions) error {
...
func (s *pipelineHistoryClient) AddSyncHandler(sync PipelineHistoryHandlerFunc) {
	s.Controller().AddHandler(sync)
}

func (s *pipelineHistoryClient) AddLifecycle(name string, lifecycle PipelineHistoryLifecycle) {
	sync := NewPipelineHistoryLifecycleAdapter(name, s, lifecycle)
